...
Wick.Tools.Brush = class extends Wick.Tool {
    ...
    onMouseDown (e) {
        ...
        this.resolutionFactor = Math.min(this.TARGET_BRUSH_SIZE/this._getRealBrushSize() * Math.pow(this.smoothness, this.testSmoothnessExponent), this.MAX_RESOLUTION_FACTOR);
